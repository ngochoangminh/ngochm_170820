...
cursor.execute("CREATE TABLE customer( customerid VARCHAR(50) NOT NULL PRIMARY KEY, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, \
    ...
    state VARCHAR(50) NOT NULL, postalcode VARCHAR(10) NOT NULL, country VARCHAR(50) NOT NULL,   phonenumber VARCHAR(50) NOT NULL,\
...
with open(csv_path, mode='r') as csv_data:
    ...
    for row in csv_data_list:
        print(row)
        cursor.execute("INSERT INTO customer(customerid, firstname, lastname, companyname, billingaddress1, billingaddress2, city,state,\
